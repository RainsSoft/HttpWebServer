    ...
    public static class FormHelper
    {
        ...
        public static string Start(string id, string action, bool isAjax, params string[] options)
        {
            ...
            if (isAjax)
            {
                ...
                WebHelper.GenerateHtmlAttributes(sb, options, new string[]{"onsubmit", onsubmit, "id", id, "method", "post"});
            }
            else
                WebHelper.GenerateHtmlAttributes(sb, options, new string[]{"id", id, "method", "post"});
